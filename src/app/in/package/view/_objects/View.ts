...
abstract class ViewElement {
    ...
    public id_compliant(id_list: string[]): { ok: boolean, id_list: string[] } {
...
class View extends ViewElement {
    ...
    constructor(schem: any = {}, type: string) {
        ...
        if (scheme['header']) {
            ...
            this.header = new ViewHeader({}, this.type);
        }
        if (scheme['actions']) {
    ...
    override id_compliant(id_list: string[]): { ok: boolean; id_list: string[]; } {
        ...
        if (this._has_header) {
            ...
            if (!ret.ok) {
                return { ok: false, id_list: ret.id_list }
            }
        }
        // ACTIONS
        if (this._has_actions) {
