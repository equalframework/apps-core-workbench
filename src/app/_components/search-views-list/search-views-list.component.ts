...
@Component({
    selector: 'search-views-list',
    templateUrl: './search-views-list.component.html',
    styleUrls: ['./search-views-list.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SearchViewsListComponent implements OnInit {
